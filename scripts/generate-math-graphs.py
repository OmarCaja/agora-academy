...
# ── 5. FUNCIONES ELEMENTALES: Lineal ────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-4, 4), (-4, 4))
x_lin = np.linspace(-4, 4, 100)
ax.plot(x_lin, 2*x_lin - 1, color=BLUE, lw=2.5, zorder=4)
ax.plot([0, 0], [0, -1], ls='--', color=RED, lw=1)
ax.plot(0, -1, 'o', color=RED, ms=6)
ax.text(0.5, -1, '$n=-1$', color=RED)
ax.text(-2, 2, '$f(x)=2x-1$', fontsize=12, color=BLUE)
ax.set_title('Función lineal (primer grado)')
path = os.path.join("public/ejemplos/funciones-elementales", 'lineal.png')
os.makedirs(os.path.dirname(path), exist_ok=True)
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 6. FUNCIONES ELEMENTALES: Cuadrática ────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-1, 5), (-2, 6))
x_cuad = np.linspace(-1, 5, 200)
ax.plot(x_cuad, x_cuad**2 - 4*x_cuad + 3, color=BLUE, lw=2.5, zorder=4)
ax.plot(2, -1, 'o', color=ORANGE, ms=8, zorder=6)
ax.plot([2, 2], [-1, 0], ls='--', color=ORANGE, lw=1)
ax.text(2, -1.8, 'Vértice $(2, -1)$', color=ORANGE, ha='center')
ax.text(3, 4, '$f(x)=x^2-4x+3$', fontsize=12, color=BLUE)
ax.set_title('Función cuadrática (segundo grado)')
path = os.path.join("public/ejemplos/funciones-elementales", 'cuadratica.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 7. FUNCIONES ELEMENTALES: Racional ──────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-2, 6), (-3, 5))
x_rac1 = np.linspace(-2, 1.85, 200)
x_rac2 = np.linspace(2.15, 6, 200)
ax.plot(x_rac1, 1/(x_rac1 - 2) + 1, color=BLUE, lw=2.5, zorder=4)
ax.plot(x_rac2, 1/(x_rac2 - 2) + 1, color=BLUE, lw=2.5, zorder=4)
ax.axvline(2, ls='--', color=RED, lw=1.5, zorder=3, label='Asíntota vertical $x=2$')
ax.axhline(1, ls='--', color=GREEN, lw=1.5, zorder=3, label='Asíntota horizontal $y=1$')
ax.text(3.5, 4, r'$f(x)=\frac{1}{x-2}+1$', fontsize=12, color=BLUE)
ax.set_title('Función racional trasladada')
ax.legend(fontsize=9, framealpha=0.8, loc='lower right')
path = os.path.join("public/ejemplos/funciones-elementales", 'racional.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 8. FUNCIONES ELEMENTALES: Radical ───────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-3, 7), (-1, 4))
x_rad = np.linspace(-2, 7, 400)
ax.plot(x_rad, np.sqrt(x_rad + 2), color=BLUE, lw=2.5, zorder=4)
ax.plot(-2, 0, 'o', color=RED, ms=8, zorder=6)
ax.text(-2, -0.6, 'Origen $(-2, 0)$', color=RED, ha='center')
ax.text(2, 2.5, r'$f(x)=\sqrt{x+2}$', fontsize=12, color=BLUE)
ax.set_title('Función radical')
path = os.path.join("public/ejemplos/funciones-elementales", 'radical.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 9. FUNCIONES ELEMENTALES: Exponencial ───────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
...
ax.legend(fontsize=9, framealpha=0.8, loc='upper center')
path = os.path.join("public/ejemplos/funciones-elementales", 'exponencial.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 10. FUNCIONES ELEMENTALES: Logarítmica ──────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-1, 6), (-4, 4))
x_log = np.linspace(0.01, 6, 400)
ax.plot(x_log, np.log2(x_log), color=BLUE, lw=2.5, zorder=4)
ax.axvline(0, ls='--', color=RED, lw=1.5, zorder=3, label='Asíntota $x=0$')
ax.plot(1, 0, 'o', color=ORANGE, ms=8, zorder=6)
ax.text(1.3, -0.5, '$(1, 0)$', color=ORANGE)
ax.text(3, 2.5, r'$f(x)=\log_2(x)$', fontsize=12, color=BLUE)
ax.set_title('Función logarítmica')
ax.legend(fontsize=9, framealpha=0.8, loc='lower right')
path = os.path.join("public/ejemplos/funciones-elementales", 'logaritmica.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── 11. Función periódica ───────────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(6, 4))
draw_axes(ax, (-7.5, 7.5), (-2, 2.5))
ax.set_xticks([-2*np.pi, -np.pi, 0, np.pi, 2*np.pi])
ax.set_xticklabels([r'$-2\pi$', r'$-\pi$', '0', r'$\pi$', r'$2\pi$'])
x_per = np.linspace(-7.5, 7.5, 500)
ax.plot(x_per, np.sin(x_per), color=BLUE, lw=2.5, zorder=4)
# Mark a period
ax.annotate('', xy=(2*np.pi, 1.2), xytext=(0, 1.2),
            arrowprops=dict(arrowstyle='<->', color=RED, lw=1.5))
ax.plot([0, 0], [0, 1.3], ls='--', color=LGRAY, lw=1)
ax.plot([2*np.pi, 2*np.pi], [0, 1.3], ls='--', color=LGRAY, lw=1)
ax.text(np.pi, 1.35, r'Periodo $T = 2\pi$', color=RED, ha='center')
ax.text(4, -1.5, r'$f(x)=\sin(x)$', fontsize=12, color=BLUE)
ax.set_title('Función periódica')
path = os.path.join("public/ejemplos/funciones", 'funcion-periodica.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")
...
ax.plot(x, x**2, color=LGRAY, lw=1.5, ls='--', label='$y = x^2$')
ax.plot(x, (x-2)**2 + 1, color=BLUE, lw=2.5, label='$y = (x-2)^2 + 1$')
ax.annotate('', xy=(2, 0), xytext=(0, 0), arrowprops=dict(arrowstyle='->', color=RED, lw=1.5))
ax.annotate('', xy=(2, 1), xytext=(2, 0), arrowprops=dict(arrowstyle='->', color=GREEN, lw=1.5))
ax.text(1, -0.5, '+2 (derecha)', color=RED, fontsize=9, ha='center')
ax.text(2.2, 0.5, '+1 (arriba)', color=GREEN, fontsize=9, va='center')
ax.set_title('Traslación de la Parábola')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'traslacion-cuadratica.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── TRASLACIONES: Racional ──────────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-6, 4), (-4, 4))
x1, x2 = np.linspace(-6, -0.1, 200), np.linspace(0.1, 4, 200)
ax.plot(x1, 1/x1, color=LGRAY, lw=1.5, ls='--', label='$y = 1/x$')
ax.plot(x2, 1/x2, color=LGRAY, lw=1.5, ls='--')
x3, x4 = np.linspace(-6, -2.1, 200), np.linspace(-1.9, 4, 200)
ax.plot(x3, 1/(x3+2) - 1, color=BLUE, lw=2.5, label='$y = \\frac{1}{x+2} - 1$')
ax.plot(x4, 1/(x4+2) - 1, color=BLUE, lw=2.5)
ax.axvline(-2, ls=':', color=RED, lw=1.2)
ax.axhline(-1, ls=':', color=GREEN, lw=1.2)
ax.set_title('Traslación de la Hipérbola')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'traslacion-racional.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── TRASLACIONES: Radical ───────────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-4, 6), (-1, 6))
x_base = np.linspace(0, 6, 400)
ax.plot(x_base, np.sqrt(x_base), color=LGRAY, lw=1.5, ls='--', label='$y = \\sqrt{x}$')
x_trans = np.linspace(-3, 6, 400)
ax.plot(x_trans, np.sqrt(x_trans+3) + 2, color=BLUE, lw=2.5, label='$y = \\sqrt{x+3} + 2$')
ax.annotate('', xy=(-3, 0), xytext=(0, 0), arrowprops=dict(arrowstyle='->', color=RED, lw=1.5))
ax.annotate('', xy=(-3, 2), xytext=(-3, 0), arrowprops=dict(arrowstyle='->', color=GREEN, lw=1.5))
ax.set_title('Traslación de la Función Radical')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'traslacion-radical.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── TRASLACIONES: Exponencial ───────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-4, 4), (-3, 6))
x = np.linspace(-4, 4, 400)
ax.plot(x, 2**x, color=LGRAY, lw=1.5, ls='--', label='$y = 2^x$')
ax.plot(x, 2**(x-1) - 2, color=BLUE, lw=2.5, label='$y = 2^{x-1} - 2$')
ax.axhline(-2, ls=':', color=GREEN, lw=1.2)
ax.set_title('Traslación de la Función Exponencial')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'traslacion-exponencial.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── TRASLACIONES: Logarítmica ───────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-3, 6), (-4, 4))
x_base = np.linspace(0.01, 6, 400)
ax.plot(x_base, np.log2(x_base), color=LGRAY, lw=1.5, ls='--', label='$y = \log_2(x)$')
x_trans = np.linspace(-1.99, 6, 400)
ax.plot(x_trans, np.log2(x_trans+2) + 1, color=BLUE, lw=2.5, label='$y = \log_2(x+2) + 1$')
ax.axvline(-2, ls=':', color=RED, lw=1.2)
ax.set_title('Traslación de la Función Logarítmica')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'traslacion-logaritmica.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── REFLEXIÓN: Radical sqrt(-x) ─────────────────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-6, 2), (-1, 4))
x_pos = np.linspace(0, 2, 200)
x_neg = np.linspace(-6, 0, 400)
ax.plot(x_pos, np.sqrt(x_pos), color=LGRAY, lw=1.5, ls='--', label='$y = \\sqrt{x}$')
ax.plot(x_neg, np.sqrt(-x_neg), color=BLUE, lw=2.5, label='$y = \\sqrt{-x}$')
ax.set_title('Reflexión: $f(x) = \\sqrt{-x}$')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'radical-reflexion.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")

# ── LOGARITMO DECRECIENTE (0 < base < 1) ───────────────────────────────────
fig, ax = plt.subplots(figsize=(5, 5))
draw_axes(ax, (-1, 6), (-4, 4))
x_log = np.linspace(0.01, 6, 400)
ax.plot(x_log, np.log2(x_log), color=LGRAY, lw=1.5, ls='--', label='base $a=2$ (creciente)')
# log_0.5(x) = ln(x) / ln(0.5)
ax.plot(x_log, np.log(x_log)/np.log(0.5), color=BLUE, lw=2.5, label='base $a=0.5$ (decreciente)')
ax.axvline(0, ls='--', color=RED, lw=1.2)
ax.set_title('Logaritmo Decreciente')
ax.legend(fontsize=9)
path = os.path.join("public/ejemplos/funciones-elementales", 'logaritmica-decreciente.png')
fig.savefig(path, dpi=150, bbox_inches='tight', facecolor='white')
plt.close(fig)
print(f"✅  {path}")
